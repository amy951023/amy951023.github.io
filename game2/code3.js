...
gdjs.Game_32WinCode.GDWin_9595signObjects1= [];
gdjs.Game_32WinCode.GDWin_9595signObjects2= [];
gdjs.Game_32WinCode.GDNewSpriteObjects1= [];
gdjs.Game_32WinCode.GDNewSpriteObjects2= [];
gdjs.Game_32WinCode.GDBrownButtonWithShadowObjects1= [];
gdjs.Game_32WinCode.GDBrownButtonWithShadowObjects2= [];
...
gdjs.copyArray(runtimeScene.getObjects("BrownButtonWithShadow"), gdjs.Game_32WinCode.GDBrownButtonWithShadowObjects1);

let isConditionTrue_0 = false;
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.Game_32WinCode.GDBrownButtonWithShadowObjects1.length;i<l;++i) {
    if ( gdjs.Game_32WinCode.GDBrownButtonWithShadowObjects1[i].IsClicked((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)) ) {
        isConditionTrue_0 = true;
        gdjs.Game_32WinCode.GDBrownButtonWithShadowObjects1[k] = gdjs.Game_32WinCode.GDBrownButtonWithShadowObjects1[i];
        ++k;
    }
}
gdjs.Game_32WinCode.GDBrownButtonWithShadowObjects1.length = k;
if (isConditionTrue_0) {
...
gdjs.Game_32WinCode.GDWin_9595signObjects1.length = 0;
gdjs.Game_32WinCode.GDWin_9595signObjects2.length = 0;
gdjs.Game_32WinCode.GDNewSpriteObjects1.length = 0;
gdjs.Game_32WinCode.GDNewSpriteObjects2.length = 0;
gdjs.Game_32WinCode.GDBrownButtonWithShadowObjects1.length = 0;
gdjs.Game_32WinCode.GDBrownButtonWithShadowObjects2.length = 0;
